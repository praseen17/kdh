...
const Invisalign = () => (
  <motion.div className="kdh-service-page" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.7 }}>
    ...
    <section className="kdh-service-hero">
      <img src="https://via.placeholder.com/700x220?text=Clear+Aligners" alt="Invisalign" className="kdh-service-hero-img" />
      <h1 className="kdh-service-title">Orthodontics (Invisalign)</h1>
